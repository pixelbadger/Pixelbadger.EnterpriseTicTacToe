...
resource script_sql_tic_tac_toe_db 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sql', principalName, 'tic-tac-toe-db', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
